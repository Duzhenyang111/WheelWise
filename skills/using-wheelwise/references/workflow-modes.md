...
All workflows start and end through `using-wheelwise`. It owns routing, `project-state.md`, Gate decisions, self-checks, and final synthesis.
...
Use for complete product ideas or when the user asks for a full WheelWise report.
...
Phase 2 Synthesis:
product-strategy -> commercialization -> risk-review -> feasibility-review: full-review
...
1. Ensure Phase 2 has passed Gate2 or is explicitly assumption-led.
