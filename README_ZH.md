...
11. 创建视觉说明资产，或使用中文 Mermaid 兜底图表。
12. 规划交互演示、模拟器、接口试验台、终端预览或工作流预览。
13. 生成完整中文报告文件夹。

## V4.0 流程与输出契约

WheelWise V4.0 保持 Superpowers 风格多 skill pack 架构，并升级 skill 流转：`using-wheelwise` 是总控、路由、状态管理、Gate 控制、自检和最终报告汇总者。
...
V4.0 要求 `index.html` 是经过设计的展示页，使用图片、图表、布局、视觉层级和动效呈现报告内容，不能只是把 Markdown 转成 HTML。凡是有用户可见界面的产品，还需要单独生成类似 `prototype.html` 的交互原型页，用 HTML 模拟网站、网页应用、移动应用、桌面应用、浏览器插件、接口试验台、命令行终端或自动化工具。
...
```text
报告文件夹：wheelwise-report-ai-payment-chaser/
源报告：wheelwise-report-ai-payment-chaser/report.md
网页展示：wheelwise-report-ai-payment-chaser/index.html
交互原型：wheelwise-report-ai-payment-chaser/prototype.html
```
...
该示例展示 V4 报告文件夹契约、内部状态、证据中枢、中文 Markdown 报告、设计化 HTML 展示页、产品交互原型和高信息密度视觉资产放置方式。
...
- 最终仍输出中文报告文件夹：`report.md`、`index.html`、`assets/` 和可选交互原型。
